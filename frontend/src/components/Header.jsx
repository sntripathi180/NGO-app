  ...
  return (
    <div className="flex items-center justify-between py-5 mb-5 border-b border-b-gray-400 text-sm">
      ...
      <ul className="flex items-center gap-5">
        <NavLink to="/"><li className="py-1 text-white">Home</li></NavLink>
        <NavLink to="/admin"><li className="py-1 text-white">Admin</li></NavLink>
        <NavLink to="/about"><li className="py-1 pr-4 text-white">About Us</li></NavLink>
      </ul>
          ...
          <div className="flex items-center justify-between gap-2 cursor-pointer relative group">
            ...
            <div className="absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block">
              <div className="bg-stone-100 min-w-40 rounded flex flex-col gap-4 p-4">
                <Link to="/task" className="hover:text-black cursor-pointer">Task</Link>
                <Link to="/logout" className="hover:text-black cursor-pointer">Logout</Link>
              </div>
            </div>
          </div>
        ) : (
